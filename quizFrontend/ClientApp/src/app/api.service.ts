...
export class ApiService {
  ...
  postQuestion(question) {
    this.http
      .post("http://localhost:63100/api/questions", question)
      .subscribe(res => {
        console.log(res);
      });
  }
  ...
  putQuestion(question) {
    this.http
      .put(`http://localhost:63100/api/questions/${question.id}`, question)
      .subscribe(res => {
        console.log(res);
      });
  }
  ...
  postQuiz(quiz) {
    this.http
      .post("http://localhost:63100/api/quizzes", quiz)
      .subscribe(res => {
        console.log(res);
      });
  }
  ...
  putQuiz(quiz) {
    this.http
      .put(`http://localhost:63100/api/quizzes/${quiz.id}`, quiz)
      .subscribe(res => {
        console.log(res);
      });
  }
